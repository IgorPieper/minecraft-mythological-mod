...
public class MinotaurAttackGoal extends MeleeAttackGoal {

    private MinotaurEntity entity;
    private int attackDelay = 6;
    private int ticksUntilNextAttack = 6;
    private boolean shouldCountUntilNextAttack = false;

    public MinotaurAttackGoal(PathfinderMob pMob, double pSpeedModifier, boolean pFollowingTargetEvenIfNotSeen) {
