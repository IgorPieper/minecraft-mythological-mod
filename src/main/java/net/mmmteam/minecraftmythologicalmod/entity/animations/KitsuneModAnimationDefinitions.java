...
public class KitsuneModAnimationDefinitions {
    public static final AnimationDefinition KITSUNE_WALK = AnimationDefinition.Builder.withLength(2.0417F).looping()
