...
public class MinotaurModAnimationDefinitions {
    public static final AnimationDefinition MINOTAUR_WALK = AnimationDefinition.Builder.withLength(2.0F).looping()
    ...
    public static final AnimationDefinition MINOTAUR_ATTACK = AnimationDefinition.Builder.withLength(1.0F)
            ...
            .addAnimation("head", new AnimationChannel(AnimationChannel.Targets.POSITION,
                    new Keyframe(0.0F, KeyframeAnimations.posVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
                    new Keyframe(0.5F, KeyframeAnimations.posVec(0.0F, -7.0F, -9.0F), AnimationChannel.Interpolations.LINEAR)
            ))
            .build();
}
