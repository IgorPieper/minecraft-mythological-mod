...
public class BalkanLynxModAnimationDefinitions {
    public static final AnimationDefinition BALKANLYNX_WALK = AnimationDefinition.Builder.withLength(1.0F).looping()
