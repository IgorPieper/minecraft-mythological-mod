package net.mmmteam.minecraftmythologicalmod.worldgen.portal;
    ...
    public Entity placeEntity(Entity entity, ServerLevel currentWorld, ServerLevel destinationWorld,
        ...
        if (insideDimension) {
            ...
            for (BlockPos checkPos : BlockPos.betweenClosed(destinationPos.below(10).west(10),
                ...
                if (destinationWorld.getBlockState(checkPos).getBlock() instanceof AncientPortalBlock) {
                    doSetBlock = false;
                    break;
                }
            }
            ...
            if (doSetBlock) {
                destinationWorld.setBlock(destinationPos, ModBlocks.ANCIENT_PORTAL.get().defaultBlockState(), 3);
            }
        }
